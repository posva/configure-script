...
if [ `uname` = "Darwin" ]; then
  ...
  ./configure.sh -aD -s src -o obj -b bin -c "mingw32-g++" -O "-Wall -Wextra -O2 -std=c++11 -stdlib=libc++" -Isrc -e cpp -E main -M Makefile -l "-lsfml-system -lsfml-window -lsfml-graphics" -N "-std=c++11 -stdlib=libc++" $@
fi
